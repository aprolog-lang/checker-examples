...
% Total: 5.65089 s:
% C = assn(X854930,var(X854608)) 
% L = z 
% S = [(X854608,sc(z)),(X854930,_848251)] 
% S' = [(X854608,sc(z)),(X854930,sc(z))] 
% T = [(X854608,sc(sc(sc(z)))),(X854930,z)] 
% Tau = [(X854608,z),(X854930,_848251)] 
% Tau' = [(X854608,z),(X854930,z)]  

% NEj
% Checking depth 1 2 3 4 5 6 7 8
% Total: 5.233774 s:
% C = assn(X40573,var(Y708478)) 
% L = z 
% S = [(X40573,_708443),(Y708478,sc(sc(_713350)))] 
% S' = [(X40573,sc(sc(_713350))),(Y708478,sc(sc(_713350)))] 
% T = [(X40573,z),(Y708478,sc(_712782))] 
% Tau = [(X40573,_708443),(Y708478,sc(z))] 
% Tau' = [(X40573,sc(z)),(Y708478,sc(z))] 
...
% Checking depth 1 2 3 4 5 6 7 8
% Total: 5.279588 s:
% C = assn(X59509,var(Y771955)) 
% L = z 
% S = [(X59509,_771920),(Y771955,sc(sc(sc(_776404))))] 
% S' = [(X59509,sc(sc(sc(_776404)))),(Y771955,sc(sc(sc(_776404))))] 
% T = [(X59509,z),(Y771955,sc(_774291))] 
% Tau = [(X59509,_771920),(Y771955,sc(sc(z)))] 
% Tau' = [(X59509,sc(sc(z))),(Y771955,sc(sc(z)))] 
